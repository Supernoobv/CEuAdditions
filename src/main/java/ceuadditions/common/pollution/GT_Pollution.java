...
public class GT_Pollution {
    ...
    public void addPollution(ChunkPosDimension chunk, Integer pollution) {
        CEuAdditions.proxy.dimensionWisePollution.merge(chunk, pollution, Integer::sum);
    }



    public Integer getPollution(ChunkPosDimension chunk) {
